...
class TestAbstractLvl(TestCase):
    def test_factory(self):
        from OOP.abstract_factory_pattern.map_creation import EasyLevel, MediumLevel, HardLevel
    ...
    def test_yaml_EasyLevel(self):
        import yaml
        from OOP.abstract_factory_pattern.map_creation \
            import EasyLevel, MediumLevel, HardLevel
