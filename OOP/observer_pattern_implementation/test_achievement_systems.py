...
class TestShortNotificationPrinter(TestCase):
    def test_update(self):
        from OOP.observer_pattern_implementation.achievement_systems import ShortNotificationPrinter, FullNotificationPrinter
    ...
    def test_archievement_systme(self):
        from OOP.observer_pattern_implementation.achievement_systems \
